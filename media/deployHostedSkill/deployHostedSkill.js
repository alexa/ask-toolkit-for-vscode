  ...
  window.addEventListener("message", (event) => {
    ...
    if (
      ...
      exportSkillPackageText.style.display =
        content.state === skillPackageStates.outOfSync || content.state === skillPackageStates.noETag ? "inline" : "none";
      ...
      hideSkillPackageSyncTdContent(
        message.changesStateContent === undefined || message.changesStateContent.state !== localChangesStates.invalidBranch,
      );
    }
    if (
      message.skillCodeSyncStateContent !== undefined &&
