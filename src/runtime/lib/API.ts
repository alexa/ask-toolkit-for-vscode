...
export abstract class AbstractWebView {
  ...
  public showView(...args: any[]): void {
    if (this._panel === undefined || this._isPanelDisposed) {
      ...
      this._panel = window.createWebviewPanel(this.viewId, this.viewTitle, this.showOptions, this.options);
  ...
  abstract onViewChangeListener(event: WebviewPanelOnDidChangeViewStateEvent): void;
