...
export function isTokenExpired(profile: string, clientId?: string, clientSecret?: string, lwaAuthorizeHost?: string, lwaTokenHost?: string): boolean {
...
export async function refreshToken(profile: string, clientId?: string, clientSecret?: string, lwaAuthorizeHost?: string, lwaTokenHost?: string): Promise<string | undefined | void> {
    const OAuth: OAuthClient = module.exports.createOAuth(clientId, clientSecret, lwaAuthorizeHost, lwaTokenHost);
