...
export class Manifest extends AbstractResourcesConfig {
  ...
  setPublishingLocales(localesObject: any) {
    return this.setProperty(
      [MANIFEST_JSON.NAME, MANIFEST_JSON.PUBLISHING_INFORMATION.NAME, MANIFEST_JSON.PUBLISHING_INFORMATION.LOCALES.NAME],
      localesObject,
    );
  }
  ...
  setPublishingLocale(local: string, localesObject: any) {
    return this.setProperty(
      [MANIFEST_JSON.NAME, MANIFEST_JSON.PUBLISHING_INFORMATION.NAME, MANIFEST_JSON.PUBLISHING_INFORMATION.LOCALES.NAME, local],
      localesObject,
    );
  }
  ...
  setAPIsCustom(customObject: any) {
    return this.setProperty([MANIFEST_JSON.NAME, MANIFEST_JSON.APIS.NAME, MANIFEST_JSON.APIS.CUSTOM.NAME], customObject);
  }
}
