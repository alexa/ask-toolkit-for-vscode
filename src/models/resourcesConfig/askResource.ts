...
export class AskResources extends AbstractResourcesConfig {
  ...
  setSkillMetaSrc(profile: string, skillMetaSrc: string): void {
    this.setProperty(
      [ASK_RESOURCES_JSON.PROFILES, profile, ASK_RESOURCES_JSON.SKILL_METADATA.NAME, ASK_RESOURCES_JSON.SKILL_METADATA.SRC],
      skillMetaSrc,
    );
  }
  ...
  setSkillInfraType(profile: string, type: string): void {
    this.setProperty(
      [ASK_RESOURCES_JSON.PROFILES, profile, ASK_RESOURCES_JSON.SKILL_INFRASTRUCTURE.NAME, ASK_RESOURCES_JSON.SKILL_INFRASTRUCTURE.TYPE],
      type,
    );
  }
}
