...
export const AUTH_FLOW_RESULT = {
  SUCCESS: {
    title: "All done!",
    message:
      "The profile has been linked to your Amazon Developer account and made active in the toolkit. <br/>It can be changed at " +
  ...
  async onReceiveMessageListener(message: any): Promise<void> {
    ...
    if ("profileName" in message) {
      ...
      if (currentProfile === message.deleteProfile) {
        const errMsg =
          "Cannot delete the currently active profile. You can view or edit the currently active profile " +
