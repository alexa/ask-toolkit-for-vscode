...
export const sendReminderToBetaTesters = async () => {
    ...
    const command = await LowLevelCommandBuilder.buildCommand(
        OPERATION.LOW_LEVEL.SEND_REMINDER_TO_BETA_TESTERS.COMMAND,
        OPERATION.LOW_LEVEL.SEND_REMINDER_TO_BETA_TESTERS.SUB_COMMAND,
        requiredParameters
    );
