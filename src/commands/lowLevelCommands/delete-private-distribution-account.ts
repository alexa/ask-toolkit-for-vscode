...
export const deletePrivateDistributionAccount = async () => {
    ...
    const command = await LowLevelCommandBuilder.buildCommand(
        OPERATION.LOW_LEVEL.DELETE_PRIVATE_DISTRIBUTION_ACCOUNT.COMMAND,
        OPERATION.LOW_LEVEL.DELETE_PRIVATE_DISTRIBUTION_ACCOUNT.SUB_COMMAND,
        requiredParameters
    );
