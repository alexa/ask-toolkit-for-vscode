 ...
 */
export async function callAvsForRecognizeEvent(userInput: string, isNewSession: boolean, context: vscode.ExtensionContext): Promise<Record<string, any>> {
 ...
 * @param userEvent 
 */
export async function callAvsForAplUserEvent(userEvent: Record<string, any>, context: vscode.ExtensionContext): Promise<Record<string, any>> {
