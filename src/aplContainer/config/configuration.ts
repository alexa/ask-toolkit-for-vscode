 ...
 */
export const RESOURCE_NAME_REGEX = new RegExp(`^${RESOURCE_NAME_REGEX_STRING}$`);
...
export const DATASOURCES_PATH_REGEX_RELATIVE_TO_SKILL_PACKAGE =
  /response(\\|\/)display(\\|\/)([a-zA-Z0-9._-]+)(\\|\/)datasources(\\|\/)default.json/;
export const SOURCES_PATH_REGEX_RELATIVE_TO_SKILL_PACKAGE =
  /response(\\|\/)display(\\|\/)([a-zA-Z0-9._-]+)(\\|\/)sources(\\|\/)default.json/;
