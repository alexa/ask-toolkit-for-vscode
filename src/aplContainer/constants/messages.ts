...
export const PROMPT_MESSAGES = Object.freeze({
  ...
  SYNC_APL_RESOURCE_NO_RESOURCE_FOUND_IN_CONSOLE:
    "No APL documents found in the Alexa Developer Console. Create an APL document locally by clicking on Alexa Presentation Language > Create.",
});

export const ERROR_MESSAGES = Object.freeze({
  CHANGE_VIEWPORT_PROFILE_NO_APL_PREVIEW:
    "There is no APL document selected. Choose an APL document and then choose Change viewport profile",
